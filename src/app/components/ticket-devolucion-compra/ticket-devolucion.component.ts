...
@Component({
  selector: 'app-ticket-devolucion-compra',
  templateUrl: './ticket-devolucion.component.html',
  styleUrls: ['./ticket-devolucion.component.css']
})
export class TicketDevolucionCompraComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.ticketService.getTicketInfoDevolucionesCompras(this.id).subscribe(
      (resp) => {
