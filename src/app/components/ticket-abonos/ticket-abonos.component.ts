...
@Component({
  selector: 'app-ticket-abonos',
  templateUrl: './ticket-abonos.component.html',
  styleUrls: ['./ticket-abonos.component.css'],
})
export class TicketAbonosComponent implements OnInit {
  @Input() id: number;
  ...
  ngOnInit(): void {
    this.ticketService.getTicketInfoAbonos(this.id).subscribe(
      (resp) => {
        console.log(resp);
