...
@Component({
  selector: 'app-ticket-gasto',
  templateUrl: './ticket-gasto.component.html',
  styleUrls: ['./ticket-gasto.component.css']
})
export class TicketGastoComponent implements OnInit {
