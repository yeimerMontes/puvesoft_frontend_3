...
import { CategoriasComprasService } from 'src/app/services/categorias-compras.service';
import { DOCUMENT } from '@angular/common';
import { environment } from 'src/environments/environment';

@Component({
  selector: 'app-Compras-Categorias',
  templateUrl: './compras-categorias.component.html',
...
export class ComprasCategoriasComponent implements OnInit {
  ...
  constructor(
    ...
    private categoriasComprasService: CategoriasComprasService,
  ...
  getCategorias() {
    this.categoriasComprasService.getCategoriasProductos().subscribe((resp) => {
      this._arrCategorias = resp.data;
    });
  }
