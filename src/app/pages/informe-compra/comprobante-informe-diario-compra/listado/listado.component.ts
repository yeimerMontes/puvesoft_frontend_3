import { ComprobanteInformeDiarioService } from './../../../../services/comprobante-informe-diario';
...
import { ComprobanteInformeDiarioCompraService } from 'src/app/services/comprobante-informe-diario-compra';

@Component({
  selector: 'app-listado',
  templateUrl: './listado.component.html',
  styleUrls: ['../../../informe/informe.component.css', '../../../../css/modulo.css', 'listado.component.css'],
})
export class ListadoComponent implements OnInit {
  ...
  titleModule: string = 'Comprobante Informe Diario - Compras';
  ...
  private _dataReportMetodoPago: any[] = [];
  private _dataReportDetalleVenta: any = {};
  ...
  tipoFactura: any[] = tiposFacturasVentas;
  _totales: any;
  ...
  constructor(
    ...
    private comprobanteInformeDiarioCompraService: ComprobanteInformeDiarioCompraService,
  ...
  get dataReportMetodoPago() {
    return this._dataReportMetodoPago;
  }
  ...
  get dataReportDetalleVenta() {
    return this._dataReportDetalleVenta;
  }
  ...
  getService(page, perPage, typeReport: TypeReport = TypeReport.noReport) {
    this.comprobanteInformeDiarioCompraService
  ...
  getServiceMetodoPagos() {
    this.comprobanteInformeDiarioCompraService
      ...
      .subscribe((resp) => {
        this._dataReportMetodoPago = resp.data;
        this._totalesMetodoPago = resp.total;
      });
  }

  getServiceDetalleVenta() {
    this.comprobanteInformeDiarioCompraService
      ...
      .subscribe((resp) => {
        this._dataReportDetalleVenta = resp.data;
      });
  }
  ...
  getHistorial(page, typeReport: TypeReport = TypeReport.noReport): void {
    if (typeReport != TypeReport.noReport) {
      this.loaded2 = false;
      this.getServiceDetalleVenta();
      this.getServiceMetodoPagos();
