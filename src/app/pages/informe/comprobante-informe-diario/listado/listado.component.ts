...
@Component({
  ...
  styleUrls: ['../../informe.component.css', '../../../../css/modulo.css', 'listado.component.css'],
})
export class ListadoComponent implements OnInit {
  ...
  titleModule: string = 'Comprobante Informe Diario';
  ...
  constructor(
    ...
    private comprobanteInformeDiarioService: ComprobanteInformeDiarioService,
  ...
  getService(page, perPage, typeReport: TypeReport = TypeReport.noReport) {
    this.comprobanteInformeDiarioService
