...
import { CategoriasVentasService } from 'src/app/services/categorias-ventas.service';
...
export class ListadoComponent implements OnInit {
  ...
  getCategorias() {
    this.categoriasVentasService.getCategoriasProductos().subscribe((resp) => {
  ...
  getService(page, perPage, typeReport: TypeReport = TypeReport.noReport) {
    this.categoriasVentasService
      .getCategoriasDeVentasPorPagina(
        ...
        typeReport,
        perPage,
        this.search.controls.option_report.value,
      )
      .subscribe((resp) => {
