...
import { ComisionesVentaService } from 'src/app/services/comisiones-venta.servic';
import { EmpleadoService } from 'src/app/services/empleado.service';
import { headersComisionVenta } from 'src/app/constants/comision-venta';
...
export class ListadoComponent implements OnInit {
  ...
  titleModule: string = 'Comisiones de ventas';
  headers: headersMasterInterface[] = headersComisionVenta;
  ...
  */
  ...
  constructor(
    ...
    private comisionesVentaService: ComisionesVentaService,
  ...
  private getSucural(): void {
    ...
    this.isRestaurant =
      JSON.parse(decodeURIComponent(atob(localStorage.getItem(btoa('sucursal'))))).tipo_sucursal ==
      2
        ? true
        : false;
  }
