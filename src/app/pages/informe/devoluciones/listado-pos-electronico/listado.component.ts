...
export class ListadoPosElectronicoComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.activeRoute.paramMap.subscribe((params) => {
      ...
      // Actualizar el título según el valor de invoiceType
      if (this.invoiceType === '2') {
        this.titleModule = 'Notas de Ajustes POS Electrónico';
      } else if (this.invoiceType === '3') {
        this.titleModule = 'Notas Créditos Electrónicas';
        if (this.invoiceTypeNote == '1') {
          //credito
        } else {
          //debito
          this.titleModule = 'Notas Débitos Electrónicas';
        }
      }
