...
export class HistorialCajaService {
  ...
  getHistorial(page, fecha_inicial, fecha_final, size, search) {
    return this.http.get<any>(
      `${this._urlApi}/cierreCaja?page=${page}&fecha_inicial=${fecha_inicial}&fecha_final=${fecha_final}&size=${size}&search=${search}`,
      this.headers
    );
  }
}
